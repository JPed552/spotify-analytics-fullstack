  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between w-full max-w-7xl mx-auto mb-12 gap-4 mt-8 '>
        <h1 className='text-4xl font-bold mb-4'>Suas musicas mais tocadas</h1>
      ...
      <div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-20'>
        {tracks.map((track, index) => (
          <div key={track.id} className=' bg-zinc-800/50 hover:bg-zinc-800 p-6 rounded-2xl border border-zinc-700 hover:border-green-500 transition-all duration-300 gap-4'>
            {/* Ranking */}
